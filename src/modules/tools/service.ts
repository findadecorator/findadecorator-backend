import { PRICING_RULES_V1 } from "../../../pricing-engine/rules";
...
export function generateQuoteTemplate(input: { projectType: string; rooms: number; finishType: string }) {
  const baseRate = PRICING_RULES_V1.jobValueAnchorsGbp.small / 10;
...
export function estimateBudget(input: { rooms: number; condition: "good" | "average" | "poor"; finish: "standard" | "premium" }) {
